...
export const loadableFromInternalState =
   <Type extends VertexType>(vertexId: symbol) =>
   (internalState: VertexInternalState<Type>): VertexLoadableState<Type> => {
      ...
      const { status, errors } =
         statusAndErrorsFromLoadableFields(loadableFields)
